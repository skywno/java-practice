...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Map<Character, Integer> duplicatesV1 = MyStrings.countDuplicateCharactersV1(TEXT);
        ...
        Map<Character, Long> duplicatesV2 = MyStrings.countDuplicateCharactersV2(TEXT);
...
//         or: duplicatesV2.forEach( (k, v) -> System.out.print(k + "="+ v + ", "));
        ...
        Map<String, Integer> duplicatesV3 = MyStrings.countDuplicateCharactersVCP1(TEXT_CP);
        ...
        Map<String, Long> duplicatesV4 = MyStrings.countDuplicateCharactersVCP2(TEXT_CP);
