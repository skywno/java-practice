...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("LinkedHashMap solution:");
        long startTimeV1 = System.nanoTime();

        char firstcharV1 = MyString.firstNonRepeatedCharacterV1(TEXT);

        displayExecutionTime(System.nanoTime() - startTimeV1);
        System.out.println("Founded character: " + firstcharV1);

        System.out.println();
        System.out.println(" 256 ASCII codes solution:");
        long startTimeV2 = System.nanoTime();

        char firstcharV2 = MyString.firstNonRepeatedCharacterV2(TEXT);
        ...
        char firstcharV4 = MyString.firstNonRepeatedCharacterV4(TEXT);
        ...
        String firstcharV5 = MyString.firstNonRepeatedCharacterVCP4(TEXT_CP);
