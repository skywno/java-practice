...
public class Main {
    ...
    private static final String[] MELON_TYPES
            ...
            "Honey Globe", "Autumn Sweet", "Jade Dew", "Golden Prize", "Ten Me", "New" +
            " Century"};
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < ARRAY_SIZE; i++) {
            melons[i] = new Melon(MELON_TYPES[rnd.nextInt(5)],
                    2000 + rnd.nextInt(2000000));
        }
        ...
        System.out.println("\nArrays.sort(): soring 'integers', array size: " + integers.length);
        ...
        ArraySorts.bubbleSortOptimized(cloneIntegersBso);
        ...
        ArraySorts.bubbleSortOptimizedWithComparator(cloneMelonBso, byType);
