...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Date dateAfterAddingHours = DateTimes.addOrSubtractHours(date, 48);
        Date dateAfterSubtractingHours = DateTimes.addOrSubtractHours(date, -48);
        ...
        LocalDateTime ldtAfterAddingMinutes = ldt.plusMinutes(60);
        LocalDateTime ldtAfterSubtractingMinutes = ldt.minusMinutes(60);
